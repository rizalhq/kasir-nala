...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('aset/sneat')?>/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand d-flex flex-column align-items-center justify-content-center text-center">
                <div class="app-brand-logo text-primary" style="font-size: 30px; font-weight: bold; margin-top: 20px;">
                    Nala Media
                </div>
                <div style="font-size: 16px; color: #6c757d; margin-top: -3px; margin-bottom: 3px; letter-spacing: 3px;">
                    Digital Printing
                </div>
            </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat datang!</h4>
              <p class="mb-4">Tolong masukkan nama pengguna dan kata sandi dengan benar!</p>
